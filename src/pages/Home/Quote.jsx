  ...
  return (
    <>
      ...
      py-10 lg:px-24 md:px-26 sm:px-6 px-4 lg:flex-nowrap md:flex-nowrap sm:flex-wrap flex-wrap">
        <div className="lg:w-[60%] md:w-full sm:w-full w-full h-auto lg:text-start md:text-start sm:text tex-center">
        ...
        <div className="lg:w-[60%] md:w-[50%] sm:w-full w-full h-auto relative overflow-hidden">
            <img 
